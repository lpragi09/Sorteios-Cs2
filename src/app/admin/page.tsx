...
import { Shield, Users, Gift, CheckCircle, XCircle, ExternalLink, Plus, Pencil, Save, X, Upload, Trash2, Coins, BarChart3, Trophy, PlayCircle, RefreshCw, Lock, Unlock, TrendingUp, Sparkles, Zap } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  // --- LÓGICA DO SORTEIO ÉPICO (REVEAL 2.0) ---
  const iniciarSorteio = () => {
    ...
    // 1. Escolhe o Ganhador Real (Weighted Random)
    ...
    // 2. Animação Progressiva
    let interacoes = 0;
    const maxInteracoes = 50; // Mais tempo girando

    const loopSorteio = () => {
        setParticipanteFake(candidatos[Math.floor(Math.random() * candidatos.length)]);
        interacoes++;

        // Aumenta o tempo entre trocas conforme chega no final (efeito desacelerar)
        let delay = 50; // Velocidade inicial
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white p-4 md:p-8 overflow-x-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        {/* MODAIS CRIAR/EDITAR (SEM ALTERAÇÕES) */}

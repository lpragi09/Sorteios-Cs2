...
export default function AdminDashboard() {
  ...
  return (
    <main className="min-h-screen bg-[#0f1014] text-white p-4 md:p-8 pt-32 overflow-x-hidden">
        ...
        {abaAtiva === "dashboard" && (
            <div className="animate-in fade-in slide-in-from-bottom-2 duration-500 space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-[#1b1e24] p-6 rounded-2xl border border-white/5 flex items-center gap-4 transition hover:border-yellow-500/50 hover:bg-[#1b1e24]/80"><div className="bg-yellow-500/10 w-14 h-14 rounded-xl flex items-center justify-center text-yellow-500"><Gift /></div><div><h3 className="text-slate-400 text-xs font-bold uppercase tracking-widest">Sorteios Ativos</h3><p className="text-3xl font-black">{totalSorteiosAtivos}</p></div></div>
                    <div className="bg-[#1b1e24] p-6 rounded-2xl border border-white/5 flex items-center gap-4 transition hover:border-blue-500/50 hover:bg-[#1b1e24]/80"><div className="bg-blue-500/10 w-14 h-14 rounded-xl flex items-center justify-center text-blue-500"><Users /></div><div><h3 className="text-slate-400 text-xs font-bold uppercase tracking-widest">Entradas Ativas</h3><p className="text-3xl font-black">{totalEntradasAtivas}</p></div></div>
                    <div className="bg-[#1b1e24] p-6 rounded-2xl border border-white/5 flex items-center gap-4 transition hover:border-green-500/50 hover:bg-[#1b1e24]/80"><div className="bg-green-500/10 w-14 h-14 rounded-xl flex items-center justify-center text-green-500"><Coins /></div><div><h3 className="text-slate-400 text-xs font-bold uppercase tracking-widest">Pool Ativo</h3><p className="text-3xl font-black text-green-400">{totalCoinsAtivos}</p></div></div>
                </div>
                    ...
                    {sorteando ? (
                        <div className="space-y-12 animate-in zoom-in-90 duration-300">
                            ...
                            <div className="relative group">
                                ...
                                {/* Slot Machine Visual */}
                                <div className="w-56 h-56 md:w-72 md:h-72 mx-auto rounded-full border-[8px] border-[#0f1014] p-2 shadow-2xl bg-[#0f1014] relative overflow-hidden">
                                ...
                                <div className="mt-8 py-4 bg-[#1b1e24]/50 backdrop-blur-md rounded-2xl border border-white/5 shadow-xl overflow-hidden relative">
                        ...
                        <div className="space-y-8 animate-in fade-in zoom-in-50 duration-1000 ease-out flex flex-col items-center">
                            ...
                            <div className="relative">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="w-64 h-64 md:w-80 md:h-80 mx-auto rounded-full border-[10px] border-green-500 p-2 shadow-[0_0_100px_rgba(34,197,94,0.5)] bg-[#0f1014] transform hover:scale-105 transition duration-500">
                                        <img 
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-4">
                                    <div className="px-6 py-3 bg-[#1b1e24] border border-white/5 rounded-2xl flex items-center gap-3">

                ...
                <div className="w-full max-w-2xl text-center relative z-10">
                    {sorteando ? (
                        ...
                        <div className="space-y-8 animate-in fade-in zoom-in-50 duration-1000 ease-out flex flex-col items-center">
                            ...
                            <div className="bg-slate-900/80 p-6 rounded-2xl border border-slate-800"><p className="text-slate-400 uppercase text-xs font-bold mb-1 tracking-widest text-center">ID do Ganhador</p><p className="text-2xl font-mono text-yellow-500 text-center">{ganhadorRevelado.csgobigId}</p></div>

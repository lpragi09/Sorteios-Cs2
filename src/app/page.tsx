        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section id="parceiros" className="border-t border-white/5 pt-20 pb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto justify-items-center">
                ...
                <a
                    href="https://pirateswap.com/?ref=soares"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Abrir parceiro PirateSwap (cupom Soares)"
                    className="w-full max-w-md bg-[#1b1e24]/90 backdrop-blur-md p-6 rounded-2xl border border-white/5 hover:border-yellow-500/50 transition duration-300 group hover:-translate-y-1 shadow-lg hover:shadow-yellow-500/10 block"
                >
                    <div className="aspect-[4/5] w-full overflow-hidden rounded-xl bg-[#0f1014] flex items-center justify-center">
                        <img src="/pirate.png" alt="PirateSwap Cupom Soares" className="w-full h-full object-contain object-center drop-shadow-md transition group-hover:scale-[1.02]"/>
                    </div>
                </a>
            </div>
          </section>
